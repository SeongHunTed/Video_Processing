...
if image is None: raise Exception("영ㅅㅏㅇ 파일 읽기 오류 발생")
...
image2 = time_check(pixel_access2, "[방법2] item() func 방식")
image3 = time_check(pixel_access3, "[방법3] Lookup table 방식")
image4 = time_check(pixel_access4, "[방법4] OpenCv func 방식")
image5 = time_check(pixel_access5, "[방법5] ndarray 방식")

cv2.imshow("image - original", image)
cv2.imshow("image1 - directly acces to pixel", image1)
